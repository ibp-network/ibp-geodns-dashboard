                      ...
                      return (
                        <div key={member.name}>
                          <div className="current-month-stats">
                            ...
                            <div className={`stat-card ${avgUptime >= 99.99 ? 'success' : avgUptime >= 99.9 ? 'warning' : 'error'}`}>
                              <div className="stat-label">Average Service Uptime</div>
                              <div className={`stat-value ${avgUptime >= 99.99 ? 'success' : avgUptime >= 99.9 ? 'warning' : 'error'}`}>
                                {avgUptime.toFixed(2)}%
                              </div>
                            </div>
